...
export const BarDivProgress = styled.div`
width: 100%;
    height: 5px;
    background: #2e2e2e;
`;

export const BarDivPlayerBlock = styled.div`
height: 73px;
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
...
export const BarDivPlayer = styled.div`
display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -webkit-box-orient: horizontal;
...
export const BarPlayerTrackPlayLikeDis = styled.div`
display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -webkit-box-orient: horizontal;
...
export const BarPlayerTrackPlayContain = styled.div`
width: auto;
    display: -ms-grid;
    display: grid;
...
export const BarVolumeImg = styled.div`
width: 13px;
    height: 18px;
    margin-right: 17px;
`
